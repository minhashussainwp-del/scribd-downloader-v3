...
const CORE_SYSTEM_PAGES: PageConfig[] = [
  ...
  },
  {
    ...
    slug: "/how-it-works",
    status: "published",
    metaTitle: "How to Download Scribd Documents as PDF - Step-by-Step Guide",
    metaDescription: "Learn how to download Scribd documents as PDF in three simple steps. No login, no software to install.",
  ...
  },
  {
    ...
    slug: "/about",
    status: "published",
    metaTitle: "About Scribd Downloader - Free PDF Tool, No Login",
    metaDescription: "About our free Scribd downloader: what it does, what it doesn't do, and how we handle your data.",
  ...
  },
  {
    ...
    slug: "/contact",
    status: "published",
    metaTitle: "Contact Us - Scribd Downloader Support",
    metaDescription: "Questions, broken links, or copyright requests? Send us a message through the contact form.",
  ...
  },
  {
    ...
    metaDescription: "How we handle your data: no accounts, no personal details, and temporary files deleted after processing.",
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-700">
                    URL Route Slug {editingPage.id !== "core-home" && "*"}
                  </label>
                  <div className="flex items-center">
                    ...
                    <input
                      type="text"
                      required={editingPage.id !== "core-home"}
                      disabled={editingPage.id === "core-home"}
                      placeholder={editingPage.id === "core-home" ? "Root URL (Not Editable)" : "e.g. dmca-notice"}
                      value={editingPage.id === "core-home" ? "" : editingPage.slug.replace(/^\/+/, "")}
                      onChange={(e) =>
                        setEditingPage({
                          ...editingPage,
                      ...
                      className="w-full px-3.5 py-2.5 rounded-r-xl border border-slate-300 text-xs font-mono text-indigo-600 font-bold focus:outline-none focus:border-indigo-500 disabled:bg-slate-50 disabled:text-slate-400"
                    />
                  </div>
                </div>
              </div>
