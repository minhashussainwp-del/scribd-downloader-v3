      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            {/* FAQ Section (renders post.faqs when present) */}
              ...
              <div className="pt-8 space-y-4">
                ...
                <div className="space-y-3">
                  {post.faqs.map((f, fIdx) => (
                    <details
                      key={fIdx}
                      className="bg-slate-50 border border-slate-200/80 rounded-xl px-5 py-4 group"
                    >
                      <summary className="text-sm sm:text-base font-bold text-slate-900 cursor-pointer list-none flex items-center justify-between gap-3">
